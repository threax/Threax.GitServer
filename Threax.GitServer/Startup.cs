...
namespace Threax.GitServer
{
    public class Startup
    {
        ...
        {
            Scope = "Threax.GitServer", //The name of the scope for api access
            DisplayName = "Threax.GitServer", //Change this to a pretty name for the client/resource
            ClientId = "Threax.GitServer", //Change this to a unique client id
