...
class AppMenuController {
    ...
    private authorizedKeys: controller.OnOffToggle;
    ...
    constructor(bindings: controller.BindingCollection,
        ...
        this.authorizedKeys = bindings.getToggle("authorizedKeys");
    ...
    public async setup(): Promise<void> {
        ...
        let showAdmin = false;
        showAdmin = this.authorizedKeys.mode = entry.canListAuthorizedKeys() || showAdmin;
